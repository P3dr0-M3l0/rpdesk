...
2. O `GerenciadorDeTempo` notifica globalmente o evento `NovoDiaIniciado`.
...
4. Os atributos blindam a variável e notificam o evento `EntidadeDanoRecebido` no `EventManager`.
